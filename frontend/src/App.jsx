...
function App() {
  ...
  return (
    <div className="min-h-screen bg-transparent text-zinc-100 flex items-center justify-center px-4 py-12 relative overflow-hidden font-sans">
      ...
      {/* 1. THE MOVED GENERATED IMAGE BACKGROUND */}
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        />
        {/* Layered Gradient Overlays for SOC Aesthetic Depth */}
          ...
          {results && !loading && (
            ...
            >
              <div className="grid gap-6 md:grid-cols-2">
                ...
                {/* Verdict Card */}
                <Card delay={0.1} className={isDeepfake ? "border-red-500/30" : "border-emerald-500/30"}>
                  <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-transparent to-current opacity-5 pointer-events-none rounded-br-2xl" />
